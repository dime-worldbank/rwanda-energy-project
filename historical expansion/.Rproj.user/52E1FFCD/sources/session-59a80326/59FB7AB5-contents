...
village_ntl_all <- read_xlsx(path = file.path(path = file.path(historical_data_path, "Nightlight", "data", "viirs_2014-2023(monthly&yearly)_5.xlsx"))) %>% 
...
tex_file_ntl_2014_usage <- file.path(
  output_path, "regressions",
  "elec14_usage_ntl_2014_viirs_5.tex"
)
...
tex_file_ntl_2014 <- file.path(
  output_path, "regressions",
  "elec14_ntl_2014_cell_viirs_5.tex"
)
...
tex_file_ntl_2014_usage <- file.path(
  output_path, "regressions",
  "elec14_usage_ntl_2014_cell_viirs_5.tex"
)
