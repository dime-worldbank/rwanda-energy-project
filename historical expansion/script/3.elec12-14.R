...
earp_join <- expansion_join_drop12_14 %>%
...
num_establishment <- felm(num_establishment ~ p0_2014*elec12_14 + p1_2017*elec12_14 + p2_2020*elec12_14|village_id + cell_year + cell_office_year + health_center_year + primary_school_year |0|sector_id, data = earp_did)
summary(num_establishment)

total_employee <- felm (total_employee ~ p0_2014*elec12_14 + p1_2017*elec12_14 + p2_2020*elec12_14|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = earp_did)
...
num_establishment_19 <- felm(num_establishment ~ p0_2014*elec12_14 + p1_2017*elec12_14 + p2_2020*elec12_14|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = earp_did_19)
summary(num_establishment_19)

total_employee_19 <- felm (total_employee ~ p0_2014*elec12_14 + p1_2017*elec12_14 + p2_2020*elec12_14|village_id + cell_year + cell_office_year + health_center_year + primary_school_year |0|sector_id, data = earp_did_19)
...
num_establishment_3 <- felm(num_establishment ~ p0_2014*elec12_14 + p1_2017*elec12_14 + p2_2020*elec12_14|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = earp_did_3)
summary(num_establishment_3)

total_employee_3 <- felm (total_employee ~ p0_2014*elec12_14 + p1_2017*elec12_14 + p2_2020*elec12_14|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = earp_did_3)
...
num_establishment_7 <- felm(num_establishment ~ p0_2014*elec12_14 + p1_2017*elec12_14 + p2_2020*elec12_14+ p0_2014*elec12_14 + p1_2017*elec12_14 + p2_2020*elec12_14|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = earp_did_7)
summary(num_establishment_7)

total_employee_7 <- felm (total_employee ~ p0_2014*elec12_14 + p1_2017*elec12_14 + p2_2020*elec12_14+ p0_2014*elec12_14 + p1_2017*elec12_14 + p2_2020*elec12_14|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = earp_did_7)
...
compute_mean <- function(df, var, earp_var = "elec12_14") {
...
num_establishment_16 <- felm(num_establishment ~ p0_2014*elec12_14 + p1_2017*elec12_14 + p2_2020*elec12_14|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = earp_did_16)
summary(num_establishment_16)

total_employee_16 <- felm (total_employee ~ p0_2014*elec12_14 + p1_2017*elec12_14 + p2_2020*elec12_14|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = earp_did_16)
...
num_establishment_17 <- felm(num_establishment ~ p0_2014*elec12_14 + p1_2017*elec12_14 + p2_2020*elec12_14|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = earp_did_17)
summary(num_establishment_17)

total_employee_17 <- felm (total_employee ~ p0_2014*elec12_14 + p1_2017*elec12_14 + p2_2020*elec12_14|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = earp_did_17)
...
num_establishment_9 <- felm(num_establishment ~ p0_2014*elec12_14 + p1_2017*elec12_14 + p2_2020*elec12_14|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = earp_did_9)
summary(num_establishment_9)

total_employee_9 <- felm (total_employee ~ p0_2014*elec12_14 + p1_2017*elec12_14 + p2_2020*elec12_14|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = earp_did_9)
...
num_establishment_p <- felm(num_establishment ~ p0_2014*elec12_14 + p1_2017*elec12_14 + p2_2020*elec12_14|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = earp_p)
summary(num_establishment_p)

total_employee_p <- felm (total_employee ~ p0_2014*elec12_14 + p1_2017*elec12_14 + p2_2020*elec12_14|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = earp_p)
...
num_establishment_pu <- felm(num_establishment ~ p0_2014*elec12_14 + p1_2017*elec12_14 + p2_2020*elec12_14|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = earp_pu)
summary(num_establishment_pu)

total_employee_pu <- felm (total_employee ~ p0_2014*elec12_14 + p1_2017*elec12_14 + p2_2020*elec12_14|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = earp_pu)
