...
stargazer(
  ...
  type = "latex",
  out = file.path(output_path, "regressions", "eventstudy_est_below_median_wholesale.tex"),
  title = "Event Study Number of Establishments Below Median in Baseline(wholesale)",
...
stargazer(
  ...
  type = "latex",
  out = file.path(output_path, "regressions", "eventstudy_est_above_median_wholesale.tex"),
  title = "Event Study Number of Establishments Above Median in Baseline(wholesale)",
...
stargazer(
  ...
  type = "latex",
  out = file.path(output_path, "regressions", "eventstudy_emp_below_median_wholesale.tex"),
  title = "Event Study Number of Employees Below Median in Baseline(wholesale)",
...
stargazer(
  ...
  type = "latex",
  out = file.path(output_path, "regressions", "eventstudy_emp_above_median_wholesale.tex"),
  title = "Event Study Number of Employees Above Median in Baseline(wholesale)",
