...
elec15_17_did_all <- elec15_17_did_isic %>% 
  group_by(village_id, year)%>% 
  summarise(num_establishment = sum(num_establishment, na.rm = TRUE),
            total_employee = sum(total_employee, na.rm = TRUE))


elec15_17_did_all <- left_join(elec15_17_did_all, elec15_17) %>% 
  mutate(
    cell_id    = substr(village_id, 1, 6),
    sector_id  = substr(village_id, 1, 4),
    district_id= substr(village_id, 1, 2)
...
num_establishment<- felm(num_establishment ~ p_1_2011*elec15_17 + p1_2017*elec15_17 + p2_2020*elec15_17|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = elec15_17_did_all)

summary(num_establishment)

total_employee <- felm (total_employee ~ p_1_2011*elec15_17 + p1_2017*elec15_17 + p2_2020*elec15_17|village_id + cell_year + cell_office_year + health_center_year + primary_school_year |0|sector_id, data = elec15_17_did_all)
...
elec15_17_did_19 <- elec15_17_did_isic %>% 
  filter(isic == 19)%>% 
  mutate(
    total_employee = pmin(total_employee, 100)   
  ) 
...
num_establishment_19 <- felm(num_establishment ~ p_1_2011*elec15_17 + p1_2017*elec15_17 + p2_2020*elec15_17|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = elec15_17_did_19)
summary(num_establishment_19)

total_employee_19 <- felm (total_employee ~ p_1_2011*elec15_17 + p1_2017*elec15_17 + p2_2020*elec15_17|village_id + cell_year + cell_office_year + health_center_year + primary_school_year |0|sector_id, data = elec15_17_did_19)
...
elec15_17_did_3 <- elec15_17_did_isic %>% 
  filter(isic == 3)%>% 
  mutate(
    total_employee = pmin(total_employee, 100)   
  ) 
...
mean(elec15_17_did_3$num_establishment)
mean(elec15_17_did_3$total_employee)

num_establishment_3 <- felm(num_establishment ~ p_1_2011*elec15_17 + p1_2017*elec15_17 + p2_2020*elec15_17|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = elec15_17_did_3)
summary(num_establishment_3)

total_employee_3 <- felm (total_employee ~ p_1_2011*elec15_17 + p1_2017*elec15_17 + p2_2020*elec15_17|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = elec15_17_did_3)
summary(total_employee_3)


##ISIC 7-----
elec15_17_did_7 <- elec15_17_did_isic %>% 
  filter(isic == 7)%>% 
  mutate(
    total_employee = pmin(total_employee, 100)   
  ) 
...
mean(elec15_17_did_7$num_establishment)
mean(elec15_17_did_7$total_employee)

num_establishment_7 <- felm(num_establishment ~ p_1_2011*elec15_17 + p1_2017*elec15_17 + p2_2020*elec15_17+ p_1_2011*elec15_17 + p1_2017*elec15_17 + p2_2020*elec15_17|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = elec15_17_did_7)
summary(num_establishment_7)

total_employee_7 <- felm (total_employee ~ p_1_2011*elec15_17 + p1_2017*elec15_17 + p2_2020*elec15_17+ p_1_2011*elec15_17 + p1_2017*elec15_17 + p2_2020*elec15_17|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = elec15_17_did_7)
...
mean_1 <- paste("Mean &", paste(sprintf("%.3f", c(
  compute_mean(elec15_17_did_all,"num_establishment"),
  compute_mean(elec15_17_did_all,"total_employee"),
  compute_mean(elec15_17_did_3,"num_establishment"),
  compute_mean(elec15_17_did_3,"total_employee"),
  compute_mean(elec15_17_did_7,"num_establishment"),
  compute_mean(elec15_17_did_7,"total_employee"),
  compute_mean(elec15_17_did_19,"num_establishment"),
  compute_mean(elec15_17_did_19,"total_employee"))), collapse=" & "), "\\\\")
...
stargazer(
  ...
  type = "latex",
  out = tex_file,
  keep = c("p_1_2011:elec15_17", "elec15_17:p1_2017", "elec15_17:p2_2020"),
  keep.stat = c("n", "rsq"),
...
extract_terms_15_17 <- function(tex_file_path) {
...
extracted_terms_1 <- extract_terms_15_17(tex_file)
...
writeLines(c(
  ...
  "\\end{tabular}",
  "}%",
  "\\end{table}"), file.path(output_path, "elec15_17_ISIC_1.tex"))
...
##ISIC 16----
elec15_17_did_16 <- elec15_17_did_isic %>% 
  filter(isic == 16)%>% 
  mutate(
    total_employee = pmin(total_employee, 100)   
  ) 
...
mean(elec15_17_did_16$num_establishment)
mean(elec15_17_did_16$total_employee)

num_establishment_16 <- felm(num_establishment ~ p_1_2011*elec15_17 + p1_2017*elec15_17 + p2_2020*elec15_17|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = elec15_17_did_16)
summary(num_establishment_16)

total_employee_16 <- felm (total_employee ~ p_1_2011*elec15_17 + p1_2017*elec15_17 + p2_2020*elec15_17|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = elec15_17_did_16)
summary(total_employee_16)


##ISIC 17----
elec15_17_did_17 <- elec15_17_did_isic %>% 
  filter(isic == 17)%>% 
  mutate(
    total_employee = pmin(total_employee, 100)   
  ) 
...
mean(elec15_17_did_17$num_establishment)
mean(elec15_17_did_17$total_employee)

num_establishment_17 <- felm(num_establishment ~ p_1_2011*elec15_17 + p1_2017*elec15_17 + p2_2020*elec15_17|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = elec15_17_did_17)
summary(num_establishment_17)

total_employee_17 <- felm (total_employee ~ p_1_2011*elec15_17 + p1_2017*elec15_17 + p2_2020*elec15_17|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = elec15_17_did_17)
summary(total_employee_17)



##ISIC 9----
elec15_17_did_9 <- elec15_17_did_isic %>% 
  filter(isic == 9)%>% 
  mutate(
    total_employee = pmin(total_employee, 100)   
  ) 
...
mean(elec15_17_did_9$num_establishment)
mean(elec15_17_did_9$total_employee)

num_establishment_9 <- felm(num_establishment ~ p_1_2011*elec15_17 + p1_2017*elec15_17 + p2_2020*elec15_17|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = elec15_17_did_9)
summary(num_establishment_9)

total_employee_9 <- felm (total_employee ~ p_1_2011*elec15_17 + p1_2017*elec15_17 + p2_2020*elec15_17|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = elec15_17_did_9)
...
mean_2 <- paste("Mean &", paste(sprintf("%.3f", c(
  compute_mean(elec15_17_did_all,    "num_establishment"),
  compute_mean(elec15_17_did_all,    "total_employee"),
  compute_mean(elec15_17_did_16, "num_establishment"),
  compute_mean(elec15_17_did_16, "total_employee"),
  compute_mean(elec15_17_did_17, "num_establishment"),
  compute_mean(elec15_17_did_17, "total_employee"),
  compute_mean(elec15_17_did_9,  "num_establishment"),
  compute_mean(elec15_17_did_9,  "total_employee"))), collapse=" & "), "\\\\")
...
# Step 4: Run the extractor
extracted_terms_2 <- extract_terms_15_17(tex_file)
...
writeLines(c(
  ...
  "\\end{tabular}",
  "}%",
  "\\end{table}"), file.path(output_path, "elec15_17_ISIC_2.tex"))
...
#elec15_17 Public private sector-----
...
elec15_17_private <- elec15_17_did_isic %>% 
  mutate(
    private_sector = ifelse(isic %in% c(9,7,3,19), 1, 0)
  ) 

elec15_17_p <- elec15_17_private %>% 
...
num_establishment_p <- felm(num_establishment ~ p_1_2011*elec15_17 + p1_2017*elec15_17 + p2_2020*elec15_17|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = elec15_17_p)
summary(num_establishment_p)

total_employee_p <- felm (total_employee ~ p_1_2011*elec15_17 + p1_2017*elec15_17 + p2_2020*elec15_17|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = elec15_17_p)
summary(total_employee_p)

elec15_17_pu <- elec15_17_private %>% 
...
num_establishment_pu <- felm(num_establishment ~ p_1_2011*elec15_17 + p1_2017*elec15_17 + p2_2020*elec15_17|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = elec15_17_pu)
summary(num_establishment_pu)

total_employee_pu <- felm (total_employee ~ p_1_2011*elec15_17 + p1_2017*elec15_17 + p2_2020*elec15_17|village_id + cell_year + cell_office_year + health_center_year + primary_school_year|0|sector_id, data = elec15_17_pu)
...
mean_3 <- paste("Mean &", paste(sprintf("%.3f", c(
  compute_mean(elec15_17_did_all,    "num_establishment"),
  compute_mean(elec15_17_did_all,    "total_employee"),
  compute_mean(elec15_17_p,    "num_establishment"),
  compute_mean(elec15_17_p,    "total_employee"),
  compute_mean(elec15_17_pu, "num_establishment"),
  compute_mean(elec15_17_pu, "total_employee")
)), collapse=" & "), "\\\\")
...
extracted_terms3 <- extract_terms_15_17(tex_file)
...
writeLines(c(
  ...
  "}%",
  "\\end{table}"
),  file.path(output_path, "elec15_17_ISIC_Private.tex"))
