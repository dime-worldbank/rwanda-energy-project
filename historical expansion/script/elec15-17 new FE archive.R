...
elec15_17 <- expansion_join_drop15_17%>%
  select(village_id, elec15_17,  health_center, primary_school, cell_office, secondary_school, sector_district_office,
...
run_reg_est <- function(df) {
  list(
    ...
    num_est1 = felm(num_establishment ~ p_1_2011*`elec15_17` + p1_2017*`elec15_17` + p2_2020*`elec15_17`
                    | village_id + cell_year | 0 | sector_id, data = df),
    
    num_est2 = felm(num_establishment ~ p_1_2011*`elec15_17` + p1_2017*`elec15_17` + p2_2020*`elec15_17`
                    | village_id + cell_year + cell_office_year | 0 | sector_id, data = df),
    
    num_est3 = felm(num_establishment ~ p_1_2011*`elec15_17` + p1_2017*`elec15_17` + p2_2020*`elec15_17`
                    | village_id + cell_year + cell_office_year + health_center_year | 0 | sector_id, data = df),
    
    num_est4 = felm(num_establishment ~ p_1_2011*`elec15_17` + p1_2017*`elec15_17` + p2_2020*`elec15_17`
                    | village_id + cell_year + cell_office_year + health_center_year + primary_school_year | 0 | sector_id, data = df),
    
    num_est5 = felm(num_establishment ~ p_1_2011*`elec15_17` + p1_2017*`elec15_17` + p2_2020*`elec15_17`
                    | village_id + cell_year + cell_office_year + health_center_year + primary_school_year + secondary_school_year | 0 | sector_id, data = df),
    
    num_est6 = felm(num_establishment ~ p_1_2011*`elec15_17` + p1_2017*`elec15_17` + p2_2020*`elec15_17`
    ...
    num_est7 = felm(num_establishment ~ p_1_2011*`elec15_17` + p1_2017*`elec15_17` + p2_2020*`elec15_17`
    ...
    num_est8 = felm(num_establishment ~ p_1_2011*`elec15_17` + p1_2017*`elec15_17` + p2_2020*`elec15_17`
...
run_reg_emp <- function(df) {
  list(
    ...
    emp1 = felm(total_employee ~ p_1_2011*`elec15_17` + p1_2017*`elec15_17` + p2_2020*`elec15_17`
                | village_id + cell_year | 0 | sector_id, data = df),
    
    emp2 = felm(total_employee ~ p_1_2011*`elec15_17` + p1_2017*`elec15_17` + p2_2020*`elec15_17`
                | village_id + cell_year + cell_office_year | 0 | sector_id, data = df),
    
    emp3 = felm(total_employee ~ p_1_2011*`elec15_17` + p1_2017*`elec15_17` + p2_2020*`elec15_17`
                | village_id + cell_year + cell_office_year + health_center_year | 0 | sector_id, data = df),
    
    emp4 = felm(total_employee ~ p_1_2011*`elec15_17` + p1_2017*`elec15_17` + p2_2020*`elec15_17`
                | village_id + cell_year + cell_office_year + health_center_year + primary_school_year | 0 | sector_id, data = df),
    
    emp5 = felm(total_employee ~ p_1_2011*`elec15_17` + p1_2017*`elec15_17` + p2_2020*`elec15_17`
                | village_id + cell_year + cell_office_year + health_center_year + primary_school_year + secondary_school_year | 0 | sector_id, data = df),
    
    emp6 = felm(total_employee ~ p_1_2011*`elec15_17` + p1_2017*`elec15_17` + p2_2020*`elec15_17`
                | village_id + cell_year + cell_office_year + health_center_year + primary_school_year + secondary_school_year + sector_district_office_year | 0 | sector_id, data = df),
    
    emp7 = felm(total_employee ~ p_1_2011*`elec15_17` + p1_2017*`elec15_17` + p2_2020*`elec15_17`
                | village_id + cell_year + cell_office_year + health_center_year + primary_school_year + secondary_school_year + sector_district_office_year + industry_year | 0 | sector_id, data = df),
    
    emp8 = felm(total_employee ~ p_1_2011*`elec15_17` + p1_2017*`elec15_17` + p2_2020*`elec15_17`
                | village_id + cell_year + cell_office_year + health_center_year + primary_school_year + secondary_school_year + sector_district_office_year + industry_year + market_year | 0 | sector_id, data = df)
  )
}
...
regs_isic16_est <- run_reg_est(elec15_17_did_16)
regs_isic16_emp <- run_reg_emp(elec15_17_did_16)

# Export temporary stargazer outputs for extraction
tex_file_est <- file.path(output_path, "regressions", "raw", "elec15_17_ISIC16_est_raw.tex")
tex_file_emp <- file.path(output_path, "regressions","raw",  "elec15_17_ISIC16_emp_raw.tex")
...
mean_line <- paste(
  "Mean &",
  sprintf("%.3f", compute_mean(elec15_17_did_16, "num_establishment")), 
  "& \\multicolumn{7}{c}{} \\\\"
)
...
writeLines(c(
  ...
  "}%",
  "\\end{table}"
), file.path(output_path, "regressions",  "elec15_17_ISIC16_est.tex"))
...
mean_line <- paste(
  "Mean &",
  sprintf("%.3f", compute_mean(elec15_17_did_16, "total_employee")), 
  "& \\multicolumn{7}{c}{} \\\\"
)
writeLines(c(
  "\\begin{table}[!htbp]",
  ...
  "}%",
  "\\end{table}"
), file.path(output_path, "regressions",  "elec15_17_ISIC16_emp.tex"))
...
join_drop13 <- expansion_join_drop15_17 %>% 
...
regs_private_est <- run_reg_est(elec15_17_p)
regs_private_emp <- run_reg_emp(elec15_17_p)

# Export raw stargazer files
tex_file_priv_est <- file.path(output_path, "regressions", "raw", "elec15_17_Private_est_raw.tex")
tex_file_priv_emp <- file.path(output_path, "regressions", "raw", "elec15_17_Private_emp_raw.tex")
...
mean_line <- paste(
  "Mean &",
  sprintf("%.3f", compute_mean(elec15_17_p, "num_establishment")), 
  "& \\multicolumn{7}{c}{} \\\\"
)
...
writeLines(c(
  ...
  "}%",
  "\\end{table}"
), file.path(output_path, "regressions",  "elec15_17_Private_est.tex"))

mean_line <- paste(
  "Mean &",
  sprintf("%.3f", compute_mean(elec15_17_p, "total_employee")), 
  "& \\multicolumn{7}{c}{} \\\\"
)
writeLines(c(
  "\\begin{table}[!htbp]",
  ...
  "}%",
  "\\end{table}"
), file.path(output_path, "regressions",  "elec15_17_Private_emp.tex"))
...
regs_public_est <- run_reg_est(elec15_17_pu)
regs_public_emp <- run_reg_emp(elec15_17_pu)

# Export raw stargazer
tex_file_pub_est <- file.path(output_path, "regressions", "raw", "elec15_17_Public_est_raw.tex")
tex_file_pub_emp <- file.path(output_path, "regressions",  "raw","elec15_17_Public_emp_raw.tex")
...
mean_line <- paste(
  "Mean &",
  sprintf("%.3f", compute_mean(elec15_17_pu, "num_establishment")), 
  "& \\multicolumn{7}{c}{} \\\\"
)
...
writeLines(c(
  ...
  "}%",
  "\\end{table}"
), file.path(output_path, "regressions",  "elec15_17_Public_est.tex"))


mean_line <- paste(
  "Mean &",
  sprintf("%.3f", compute_mean(elec15_17_pu, "total_employee")), 
  "& \\multicolumn{7}{c}{} \\\\"
)
...
writeLines(c(
  ...
  "}%",
  "\\end{table}"
), file.path(output_path, "regressions",  "elec15_17_Public_emp.tex"))
...
private_priority_est <- felm(num_establishment ~ p_1_2011*`elec15_17` + p1_2017*`elec15_17` + p2_2020*`elec15_17`
                             | village_id + cell_year + cell_office_year + health_center_year + 
                               ...
                               industry_year + market_year + priority_year | 0 | sector_id, data = elec15_17_p)

summary(private_priority_est)

private_priority_emp <- felm(total_employee ~ p_1_2011*`elec15_17` + p1_2017*`elec15_17` + p2_2020*`elec15_17`
                             | village_id + cell_year + cell_office_year + health_center_year + 
                               primary_school_year + secondary_school_year + sector_district_office_year + 
                               industry_year + market_year + priority_year | 0 | sector_id, data = elec15_17_p)
...
public_priority_est<- felm(num_establishment ~ p_1_2011*`elec15_17` + p1_2017*`elec15_17` + p2_2020*`elec15_17`
                           | village_id + cell_year + cell_office_year + health_center_year + 
                             primary_school_year + secondary_school_year + sector_district_office_year + 
                             industry_year + market_year + priority_year | 0 | sector_id, data = elec15_17_pu)

summary(public_priority_est)



public_priority_emp<- felm(total_employee ~ p_1_2011*`elec15_17` + p1_2017*`elec15_17` + p2_2020*`elec15_17`
                           | village_id + cell_year + cell_office_year + health_center_year + 
                             primary_school_year + secondary_school_year + sector_district_office_year + 
                             industry_year + market_year + priority_year | 0 | sector_id, data = elec15_17_pu)
...
stargazer(
  models,
  type = "latex",
  out = file.path(output_path, "regressions", "elec15_17_priority.tex"),
  title = "Regression Results: elec15-17 with Priority Fixed Effects",
  ...
  covariate.labels = c("elec15-17 × 2011", "elec15-17 × 2017", "elec15-17 × 2020"),
  keep = c("p_1_2011:elec15_17", "elec15_17:p1_2017", "elec15_17:p2_2020"),
  omit.stat = c("adj.rsq", "ser", "f", "ll", "aic", "bic"),
  keep.stat = c("n", "rsq"),
  float = TRUE,
