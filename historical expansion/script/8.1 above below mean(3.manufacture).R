#######################################
#Purpose: Using EARP as a control for analysis (3. Manufacture)
...
stargazer(
  ...
  type = "latex",
  out = file.path(output_path, "regressions", "eventstudy_est_below_median_manufacture.tex"),
  title = "Event Study Number of Establishments Below Median in Baseline(manufacture)",
...
stargazer(
  ...
  type = "latex",
  out = file.path(output_path, "regressions", "eventstudy_est_above_median_manufacture.tex"),
  title = "Event Study Number of Establishments Above Median in Baseline(manufacture)",
...
stargazer(
  ...
  type = "latex",
  out = file.path(output_path, "regressions", "eventstudy_emp_below_median_manufacture.tex"),
  title = "Event Study Number of Employees Below Median in Baseline(manufacture)",
...
stargazer(
  ...
  type = "latex",
  out = file.path(output_path, "regressions", "eventstudy_emp_above_median_manufacture.tex"),
  title = "Event Study Number of Employees Above Median in Baseline(manufacture)",
