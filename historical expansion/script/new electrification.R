...
electrification_status_year <- utility %>% 
...
electrified_13 <- electrification_status_year%>% 
...
mean(expansion_join_drop13$cell_office[expansion_join_drop13$`earp_mv or earp_lv` == 0])
mean(expansion_join_drop13$primary_school[expansion_join_drop13$`earp_mv or earp_lv` == 0])
mean(expansion_join_drop13$health_center[expansion_join_drop13$`earp_mv or earp_lv` == 0])
...
mean(expansion_join_drop4$electrified_2018[expansion_join_drop4$`earp_mv or earp_lv` == 0])
mean(expansion_join_drop4$electrified_2020[expansion_join_drop4$`earp_mv or earp_lv` == 0])
mean(expansion_join_drop4$electrified_2022[expansion_join_drop4$`earp_mv or earp_lv` == 0])
...
mean(earp_did$num_establishment[earp_did$`earp_mv or earp_lv` == 0])
mean(earp_did$total_employee[earp_did$`earp_mv or earp_lv` == 0])
mean(earp_did_3$num_establishment[earp_did_3$`earp_mv or earp_lv` == 0])
mean(earp_did_3$total_employee[earp_did_3$`earp_mv or earp_lv` == 0 ])
mean(earp_did_7$num_establishment[earp_did_7$`earp_mv or earp_lv` == 0])
mean(earp_did_7$total_employee[earp_did_7$`earp_mv or earp_lv` == 0])
mean(earp_did_19$num_establishment[earp_did_19$`earp_mv or earp_lv` == 0])
mean(earp_did_19$total_employee[earp_did_19$`earp_mv or earp_lv` == 0])
...
mean(earp_did$num_establishment[earp_did$`earp_mv or earp_lv` == 0])
mean(earp_did$total_employee[earp_did$`earp_mv or earp_lv` == 0])
mean(earp_did_16$num_establishment[earp_did_16$`earp_mv or earp_lv` == 0])
mean(earp_did_16$total_employee[earp_did_16$`earp_mv or earp_lv` == 0])
mean(earp_did_17$num_establishment[earp_did_17$`earp_mv or earp_lv` == 0])
mean(earp_did_17$total_employee[earp_did_17$`earp_mv or earp_lv` == 0])
mean(earp_did_9$num_establishment[earp_did_9$`earp_mv or earp_lv` == 0])
mean(earp_did_9$total_employee[earp_did_9$`earp_mv or earp_lv` == 0])
...
join_drop13 <- expansion_join_drop13 %>% 
  select(`earp_mv or earp_lv`, village_id, cell_id, sector_id)
...
earp_p <- earp_private %>% 
  ...
  mutate(
    cell_year = paste0(cell_id, year)
  )

num_establishment_p <- felm(num_establishment ~ p0_2014*`earp_mv or earp_lv` + p1_2017*`earp_mv or earp_lv` + p2_2020*`earp_mv or earp_lv`|village_id + cell_year|0|sector_id, data = earp_p)
summary(num_establishment_p)

total_employee_p <- felm (total_employee ~ p0_2014*`earp_mv or earp_lv` + p1_2017*`earp_mv or earp_lv` + p2_2020*`earp_mv or earp_lv`|village_id + cell_year|0|sector_id, data = earp_p)
...
num_establishment_pu <- felm(num_establishment ~ p0_2014*`earp_mv or earp_lv` + p1_2017*`earp_mv or earp_lv` + p2_2020*`earp_mv or earp_lv`|village_id + cell_year|0|sector_id, data = earp_pu)
summary(num_establishment_pu)

total_employee_pu <- felm (total_employee ~ p0_2014*`earp_mv or earp_lv` + p1_2017*`earp_mv or earp_lv` + p2_2020*`earp_mv or earp_lv`|village_id + cell_year|0|sector_id, data = earp_pu)
...
mean(earp_p$num_establishment[earp_p$`earp_mv or earp_lv` == 0])
mean(earp_p$total_employee[earp_p$`earp_mv or earp_lv` == 0])
mean(earp_pu$num_establishment[earp_pu$`earp_mv or earp_lv` == 0])
mean(earp_pu$total_employee[earp_pu$`earp_mv or earp_lv` == 0])