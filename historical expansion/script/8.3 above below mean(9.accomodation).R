...
stargazer(
  est_cohort_est.1, est_stack_est.1, est_cohort_emp.1, est_stack_emp.1,
  type = "latex",
  out = file.path(output_path, "regressions", "eventstudy_est_below_median_food&accomodation.tex"),
  title = "Event Study Number of Establishments Below Median in Baseline(food&accomodation)",
...
stargazer(
  est_cohort_est.2, est_stack_est.2, est_cohort_emp.2, est_stack_emp.2,
  type = "latex",
  out = file.path(output_path, "regressions", "eventstudy_est_above_median_food&accomodation.tex"),
  title = "Event Study Number of Establishments Above Median in Baseline(food&accomodation)",
...
stargazer(
  emp_cohort_est.1, emp_stack_est.1, emp_cohort_emp.1, emp_stack_emp.1,
  type = "latex",
  out = file.path(output_path, "regressions", "eventstudy_emp_below_median_food&accomodation.tex"),
  title = "Event Study Number of Employees Below Median in Baseline(food&accomodation)",
...
stargazer(
  emp_cohort_est.2, emp_stack_est.2, emp_cohort_emp.2, emp_stack_emp.2,
  type = "latex",
  out = file.path(output_path, "regressions", "eventstudy_emp_above_median_food&accomodation.tex"),
  title = "Event Study Number of Employees Above Median in Baseline(food&accomodation)",
