...
pacman::p_load(fixest, tidyverse, dplyr, here, sf, ggplot2, readxl, writexl, janitor, haven, stringr, stargazer, kableExtra)
...
rwa_regress <- rwa_regress %>% 
  group_by(Distr_ID, Sector_ID, Cell_ID, year) %>% 
  summarise(
    value = mean(value),
...
ntl12_14 <- felm(value ~ p0_2014:elec12_14 + p1_2017:elec12_14 + p2_2020:elec12_14|cell_id + district_year, clustervar = "cell_id", data = elec12_14)
...
ntl15_17 <- felm(value ~ p_2_2011:elec15_17 + p0_2017:elec15_17 + p1_2020:elec15_17|cell_id + district_year, cluster = "cell_id", data = elec15_17)
...
ntl18_20 <- felm(value ~ p_3_2011:elec18_20 + p_2_2014:elec18_20 + p0_2020:elec18_20|cell_id + district_year, cluster = "cell_id", data = elec18_20)
...
employee12_14 <- felm(total_employee ~ p0_2014:elec12_14 + p1_2017:elec12_14 + p2_2020:elec12_14|cell_id + district_year, cluster = "cell_id",  data = elec12_14)
...
employee15_17 <- felm(total_employee ~ p_2_2011:elec15_17 + p0_2017:elec15_17 + p1_2020:elec15_17|cell_id + district_year, cluster = "cell_id",  data = elec15_17)
...
employee18_20 <- felm(total_employee ~ p_3_2011:elec18_20 + p_2_2014:elec18_20 + p0_2020:elec18_20|cell_id + district_year, cluster = "cell_id",  data = elec18_20)
