...
hfc_code_filepath <- "C:/Users/wb614406/OneDrive - WBG/Documents/GitHub/rwanda-energy-project/RCT_data/baseline/HFC/scripts/"
## 4. Run R Scripts ----
...
source(paste0(hfc_code_filepath,   "4.hfc_outliers.R"))

1

print("Script 4 Done.")

source(paste0(hfc_code_filepath,   "5.hfc_logic.R")) 

1

print("Script 5 Done.")

source(paste0(hfc_code_filepath,   "6.hfc_enum.R"))
